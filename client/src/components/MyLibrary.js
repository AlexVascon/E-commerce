...
export const Container = styled.div`
  ...
  margin: auto;
  ${(props) =>
    props.border && 'border-bottom: 2px solid rgba(235, 198, 36, 0.945);'}
  ${(props) =>
    props.shadow && 'box-shadow: 0px 13px 11px -5px rgba(0, 0, 0, 0.17);'}
...
export const Button = styled.button`
  ...
  background-color: ${(props) =>
    props.light ? 'rgba(253, 253, 185, 0.925);' : 'rgba(224, 192, 49, 0.808);'};
  box-shadow: ${(props) =>
    props.light
      ? '0px 4px 8px rgba(250, 243, 144, 0.616);'
      : '0px 10px 7px -2px rgba(250, 237, 177, 0.705);'};
  width: 90%;
  align-self: center;
  margin-top: 1rem;
  color: black;
